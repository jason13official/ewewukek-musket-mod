package io.github.jason13official.musketmod.impl.client;

import com.mojang.blaze3d.vertex.PoseStack;
import com.mojang.blaze3d.vertex.VertexConsumer;
import com.mojang.math.Axis;
import io.github.jason13official.musketmod.MusketMod;
import io.github.jason13official.musketmod.impl.client.BulletRenderer.BulletState;
...
public class BulletRenderer extends EntityRenderer<BulletEntity, BulletState> {
...
//    }
    ...
    public static class BulletState extends EntityRenderState {
    ...
    @Override
    public void render(BulletState bulletState, PoseStack poseStack, MultiBufferSource bufferSource, int light) {

        if (bulletState.firstTick) return;
        poseStack.pushPose();
        if (bulletState.pelletCount == 1) {
            poseStack.scale(0.1f, 0.1f, 0.1f);
        } else {
            poseStack.scale(bulletState.isOnFire ? 0.075f : 0.05f, 0.05f, 0.05f);
        }
// billboarding
        ...
        RenderType renderType = RenderType.entityCutoutNoCull(
            bulletState.isOnFire ? TEXTURE_FIRE : TEXTURE);
        ...
        super.render(bulletState, poseStack, bufferSource, light);
    }

    @Override
    public BulletState createRenderState() {
